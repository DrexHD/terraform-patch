...
import me.drex.terraformpatch.block.type.SmallLogPolymerBlock;
...
public class TerraformPolymerBlockHelper implements ModPolymerBlockHelper {
    ...
    public @Nullable PolymerBlock requestPolymerBlock(ResourceLocation id, Block block) {
        return switch (block) {
            ...
            case BareSmallLogBlock ignored -> {
                TerraformerPatch.LOGGER.warn("Bare small log block {} does not have an efficient implementation", id);
